...
const About = () => {
  return (
    <div className='flex flex-col gap-10 mb-[7%] w-full h-[500px]'>
      <div className="inline-flex items-center justify-center px-[35px] py-[15px] text-1xl 
           text-[#072C8B] font-semibold m-auto border-3 border-[#072C8B] w-[145px] h-[50px] 
